    ...
    public partial class SeedData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2022, 3, 17, 17, 40, 10, 552, DateTimeKind.Local).AddTicks(4772), 100000m, 150000m, null },
                    { 2, new DateTime(2022, 3, 17, 17, 40, 10, 555, DateTimeKind.Local).AddTicks(5710), 130000m, 200000m, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "Áo sơ mi nữ trắng Việt Tiến", "Áo sơ mi nữ trắng Việt Tiến", "vi-VN", "Áo sơ mi nữ trắng Việt Tiến", 2, "ao-so-mi-nu-trang-viet-tien", "Áo sơ mi nữ trắng Việt Tiến", "Áo sơ mi nữ trắng Việt Tiến" },
                    { 4, "Viet Tien Women T-Shirt", "Viet Tien Women T-Shirt", "en-US", "Viet Tien Women T-Shirt", 2, "Viet Tien Women T-Shirt", "Viet Tien Women T-Shirt", "Viet Tien Women T-Shirt" }
                });
